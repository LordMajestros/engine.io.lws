...
function Server(opts){
  ...
  this.disableHixie = false !== opts.disableHixie ? (opts.disableHixie || true) : false;
...
Server.prototype.onWebSocket = function(req, socketHandle){
  ...
  //console.log("Request.websocket is");
